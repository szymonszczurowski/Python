...
# sortList = sorted(percent)
# medianLow = statistics.median_low(sortList)
# medianhigh = statistics.median_low(sortList)
# print(sortList)
# print(statistics.median(sortList))

sortList = sorted(percent)
medianLow = median_low(sortList)
medianhigh = median_high(sortList)
print(sortList)
